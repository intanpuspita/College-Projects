...
$root = rtrim($_SERVER['DOCUMENT_ROOT'],'/')."/ost_2"; // don't touch this configuration
...
$base_url="http://localhost/ost_2"; //url base of site if you want only relative url leave empty

		...
		<div id="wrap">
			<section id="top">
				<nav id="mainnav">
					...
					<ul>
						<li <?php if($menu=="buku"){ echo "class='active'";}?>><a href="indexadmin.php"><span>Data Buku</span></a></li>
						<li <?php if($menu==2){ echo "class='active'";}?>><a href="photos.html"><span>Menu</span></a></li>
			...
			<section id="page">
				...
				<section id="contents">
					<?php if($menu=="buku"){ include 'data_buku.php';}
					else if($menu=="inputbuku"){ include 'input_buku.php';}
					else if($menu=="editbuku"){ include 'edit_buku.php';}?>
				</section>
				<div class="clear"></div>
				<div class="clear"></div>
			</section>

<?php
	...
	else
	{
		...
		echo "<table align='right'>
			<tr>
				<td width='120'><a href=report_absen.php?kelas=$kd_kelas&minggu=$mingguke><img src='images/print.jpg'/>Cetak Laporan</a></td>
			</tr>
		</table>";
		include('connect.php');
		...
		//$data1=mysql_query("select distinct nim from $data");

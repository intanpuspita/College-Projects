...
<form action="" method="post" name="form1">
	...
	<tr>
	  ...
	  <td width="43"><input name="Cari" type="submit" value="Cari" /></td>
    	<td width="161" align="center"><a href="index.php?menu=21"><img src="images/Insert.jpg" alt=""/>Tambah Mahasiswa</a></td>
...
<?php
	...
	else
	{
		...
		<tr>
			...
			<td width="30"><a href="kddelete_mhs.php?nim=<?php echo $tampil['nim']?>"><img src="images/delete.png" alt=""/></a></td>

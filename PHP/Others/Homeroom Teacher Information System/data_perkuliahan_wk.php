...
<body>
	...
	<?php
		if(isset($_POST['Cari'])){
			include 'kd_searchkuliah_wk.php';
		}
		else {
			...
			<table border='1' width='100%'>
				...
				<?php while($tampil = mysql_fetch_array ($data))
					...
					<tr>
						...
						<td width="30"><a href="index_wk.php?menu=61&kd_perkuliahan=<?php echo $tampil['kd_perkuliahan']?>"><img src="images/detail.png" alt=""/></a></td>
					</tr>
			<?php }
			echo "</table>";
		}

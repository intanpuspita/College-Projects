...
?>
<form id="form1" name="form1" method="post" action="kd_assignment.php">
  ...
  <table width="392" border="0" align="center">
    <tr>
      ...
      <td width="9">:</td>
      <td width="200"><label>
        <input name="txtkd_assignment" type="text" id="txtkd_assignment" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><label>
        <select name="kd_kelas">
          <option>----PILIH----</option>
		  <?php while($datakelas=(mysql_fetch_array($query_kelas))){?>
          <option><?php echo $datakelas['kd_kelas'];?></option>
		  <?php }?>
                </select>
      </label></td>
    </tr>

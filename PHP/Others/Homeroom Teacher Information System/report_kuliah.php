...
<table width="600" border="0" align="center">
  <tr>
    <td><table width="100%" border="0">
      ...
      <tr>
        <td colspan="3" valign="top"><div align="center">Report Data Perkuliahan</div></td>
        </tr>
      <tr>
        <td colspan="4"><hr /></td>
        </tr>
      <tr>
        <td colspan="4"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr bgcolor="#999999">
			...
			<td width="160" height="26"><div align="center"><span class="style3">Kode Perkuliahan</span></div></td>
            <td width="160" height="26"><div align="center"><span class="style3">Minggu Ke</span></div></td>
			<td width="160" height="26"><div align="center"><span class="style3">Tanggal Perkuliiahan</span></div></td>
            <td width="160" height="26"><div align="center"><span class="style3">Mata Kuliah</span></div></td>
          </tr>
	  ...
	  if ($nourut % 2 == 0)
		...
		$bg="#FFFFFF";
	  $nourut++;
	  $matkul=mysql_query("select * from assigment, mk, perkuliahan where assigment.kd_assignment='$data[kd_assignment]' and assigment.kd_mk=mk.kd_mk");
	  $record = mysql_fetch_array($matkul);
	  echo"
	   <tr bgcolor=\"#ffffff\">
          <td><div align=\"center\">$nourut</td>
		  <td><div align=\"center\">$data[kd_perkuliahan]</td>
          <td><div align=\"center\">$data[minggu_ke]</td>
		  <td><div align=\"center\">$data[tgl_kuliah]</td>
		  <td><div align=\"center\">$record[nama_mk]</td>
        </tr>";
		}

...
void (*tab[4]) () = {f1, f2, f3, f4}; /* Pointer ke procedure */
												  /* tab adalah array 1 dimensi bertipe pointer
												     yang akan menunjukan procedure mana yang dituju*/
/* program */
...
printf("3. Edit file \n");
printf("4. Quit \n");
tab[getchar() - '1'] () ;        /* index array tab akan diisi oleh nomor pilihan dikurangi 1 */
getchar(); 								/* untuk membuang return karakter */
} while (!quit);                 /* terus menampilkan pilihan selama pilihannya bukan quit */
return 0;
}
/* Body Function */
void f1 ()
